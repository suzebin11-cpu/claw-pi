 ...
 * - OFF bg: rgba(255,255,255,0.12) (dark-mode track)
  ...
  (
    ...
    return (
      <SwitchPrimitive.Root
        ...
        data-[state=unchecked]:bg-[rgba(255,255,255,0.12)]
        ${s.track}
        ${className ?? ""}
      `}
        {...props}
      >
        ...
        <span
          className={`
          absolute top-1/2 -translate-y-1/2 rounded-full border-[rgba(255,255,255,0.1)]
          transition-opacity duration-200
