...
function getModelsHostInvokeBridge(): ModelsHostInvokeBridge | null {
  ...
  const candidate = (window as Window & { clawpiHost?: unknown }).clawpiHost;
...
export function ModelsPage() {
  ...
  const [pendingSwitchModelId, setPendingSwitchModelId] = useState<
    string | null
  >(null);
  ...
  // Build sidebar items: Claw-Pi first, then BYOK providers
              ...
              <div className="p-2 space-y-0.5">
                {sidebarItems.map((item) => {
                  ...
                  return (
                    ...
                    >
                      <span className="w-6 h-6 shrink-0 flex items-center justify-center rounded-md bg-[rgba(255,255,255,0.06)] border border-border-subtle">
...
// ── Managed provider detail (Claw-Pi Official) ───────────────────
          ...
          <div className="space-y-0.5">
            {orderedProviderModels.map((model) => {
              ...
              return (
                ...
                >
                  <span className="w-6 h-6 rounded-md flex items-center justify-center shrink-0 bg-[rgba(255,255,255,0.06)] border border-border-subtle">
                    <ModelLogo
                      model={model.name}
