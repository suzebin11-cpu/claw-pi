...
const BOT_AVATAR = "/brand/ip-claw-pi.svg";
    ...
    <div
      ...
      className={cn(
        ...
        isBot
          ...
          : "border-border/70 bg-[rgba(255,255,255,0.06)] text-text-secondary",
      )}
    >
...
export function SessionsPage() {
  ...
  const buttonClassName = cn(
    "inline-flex h-12 items-center justify-center gap-3 rounded-[18px] border bg-surface-1 px-5 text-[13px] font-medium text-text-primary shadow-[0_10px_24px_rgba(15,23,42,0.06)] transition-colors",
