...
const FEISHU_FALLBACK_TEMPLATES: FallbackTemplateMap = {
  unknown: {
    en: "🤖 Sorry, I can't handle your request right now. Please try again later, or contact the Claw-Pi team for support: https://claw-pi.cn/",
    "zh-CN":
      "🤖 抱歉，我暂时无法处理你的请求，请稍后重试，或联系 Claw-Pi 工作人员获取支持：https://claw-pi.cn/",
  },
  internal_error: {
  ...
  synthetic_pre_llm_failure: {
    en: "Sorry, Claw-Pi intentionally interrupted this reply for diagnostics.",
    "zh-CN": "抱歉，这条回复被 Claw-Pi 为诊断目的主动中断。",
  },
};
