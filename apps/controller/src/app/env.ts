...
const envSchema = z.object({
  ...
  NEXU_CLOUD_URL: z.string().optional(),
  ...
  CLAWHUB_REGISTRY: z.string().default("https://cn.clawhub-mirror.com"),
  CLAWHUB_SEARCH_API: z.string().default("https://skills.volces.com"),
});
...
export const env = {
  ...
  nexuCloudUrl: parsed.NEXU_CLOUD_URL ?? null,
  ...
  clawHubRegistry: parsed.CLAWHUB_REGISTRY,
  clawHubSearchApi: parsed.CLAWHUB_SEARCH_API,
};
