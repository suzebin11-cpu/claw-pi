...
<p align="center">
  <a href="https://clawpi.app" target="_blank" rel="noopener"><strong>🌐 官网</strong></a> &nbsp;·&nbsp;
...
>
> 🎉 **内测福利**：内测期间，Gemini 等顶级模型 **免费使用**。[立即下载体验 →](https://clawpi.app)
...
| 平台 | 下载 |
|------|------|
| 🍎 macOS（Apple Silicon） | [官网](https://clawpi.app) |
