...
3. Local API:
   ...
   - Returns `{ browserUrl: "https://api.clawpi.app:9443/auth?desktop=1&device_id=<deviceId>" }`.
...
5. Return `{ browserUrl: "https://api.clawpi.app:9443/auth?desktop=1&device_id=<deviceId>" }`.
