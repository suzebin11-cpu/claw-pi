...
│  ├─ app.clawpi.controller.dev  → Controller (:50800)             │
│  └─ app.clawpi.openclaw.dev    → OpenClaw Gateway (:18789)       │
└──────────────────────────────────────────────────────────────┘
```
...
| | Dev | Packaged |
|---|---|---|
| Controller label | `app.clawpi.controller.dev` | `app.clawpi.controller` |
| OpenClaw label | `app.clawpi.openclaw.dev` | `app.clawpi.openclaw` |
