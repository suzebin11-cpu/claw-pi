...
<p align="center">
  <a href="https://clawpi.app" target="_blank" rel="noopener"><strong>🌐 公式サイト</strong></a> &nbsp;·&nbsp;
...
>
> 🎉 **ベータ特典**：ベータ期間中、Gemini などのトップモデルが **無料** でご利用いただけます。[今すぐダウンロード →](https://clawpi.app)
...
| プラットフォーム | ダウンロード |
|------------------|-------------|
| 🍎 macOS（Apple Silicon） | [公式サイト](https://clawpi.app) |
