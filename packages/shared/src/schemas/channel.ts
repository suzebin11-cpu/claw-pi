...
export const feishuDeviceBeginResponseSchema = z.object({
  qrUrl: z.string(),
  deviceCode: z.string(),
  interval: z.number(),
  expireIn: z.number(),
...
export const feishuDevicePollRequestSchema = z.object({
  deviceCode: z.string().min(1),
});

export const feishuDevicePollResponseSchema = z.object({
  done: z.boolean(),
...
export type FeishuDeviceBeginResponse = z.infer<
  typeof feishuDeviceBeginResponseSchema
>;
export type FeishuDevicePollRequest = z.infer<
  typeof feishuDevicePollRequestSchema
>;
export type FeishuDevicePollResponse = z.infer<
  typeof feishuDevicePollResponseSchema
>;
